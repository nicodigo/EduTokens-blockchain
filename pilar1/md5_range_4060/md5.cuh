...
// Declarado en memoria __constant__ a nivel de archivo (no dentro de la
// función): garantiza una sola copia, cacheada y con broadcast a todo el
// warp, en lugar de depender de que el compilador evite memoria local al
// inicializar este array en cada invocación de md5_transform.
// "static" da linkage interno: evita colisión de símbolos si este header
// llegara a incluirse desde más de un archivo .cu.
static __constant__ uint32_t MD5_K[64] = {
...
// Per-step rotation amounts (4 valores únicos por ronda, repetidos)
static __constant__ uint32_t MD5_S[64] = {
